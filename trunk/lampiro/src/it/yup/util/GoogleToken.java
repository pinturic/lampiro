 ...
 *
 * $Id: GoogleToken.java 1028 2008-12-09 15:44:50Z luca $
*/
...
public class GoogleToken extends Thread {
	...
	public static String getToken(String username, String password) {
		...
		try {
			// (1) Get a session ID
			// prepare the request
			String postData = "Email=" + encode(username) +
				"&Passwd=" + encode(password) +
				"&PersistentCookie=false&source=googletalk&service=mail";
			HttpConnection conn = (HttpConnection) Connector.open("https://www.google.com/accounts/ClientLogin");
